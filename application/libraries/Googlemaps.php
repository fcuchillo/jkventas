...
class Googlemaps {
	...
	var $apiKey				= 'AIzaSyA3N4fQrTCLJewcfkGpnyl22aj2mCX9oL8'; 	// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $map_height					= "450px";//"450px";					// The height of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
